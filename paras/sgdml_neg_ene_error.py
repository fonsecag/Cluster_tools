...
parameters={	
	...
	'predict_error':{
		...
		'sample_wise_comparison_var_index':3,
		# sample-wise only relevant if sample_wise = True in calculate_error

		'predicts':{
			0:{
				'predict_func':'func:sgdml_predict_E',
				'batch_size':100,
				'input_var_index':1,
			},
		...
		0:{
			...
			'save_key':'en_RMSE_c', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':True,
			'graph_paras':{
				'y_axis_label':r'Energy prediction error $(kcal/mol)$',
		...
		1:{
			...
			'error_func':'func:root_mean_squared_error',
			'save_key':'en_RMSE_o', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':False,
			'graph_paras':{
			},
		},
		...
		2:{
			...
			'file_name':'MAE_graph',
			'save_key':'en_MAE_c', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':True,
			'graph_paras':{
				'y_axis_label':r'Energy prediction error $(kcal/mol)$',
				#replace default paras here
		...
		3:{
			...
			'error_func':'func:mean_absolute_error',
			'save_key':'en_MAE_o', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':False,
			'graph_paras':{
			},
		}, 
		...
		4:{
			...
			'file_name':'MSE_graph',
			'save_key':'en_MSE_c', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':True,
			'graph_paras':{
				'y_axis_label':r'Energy prediction error $(kcal/mol)^2$',
				#replace default paras here
			},
		},
		...
		5:{
			...
			'error_func':'func:mean_squared_error',
			'save_key':'en_MSE_o', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':False,
			'graph_paras':{
			},
		},
	...
	'error_graph_default':{
		...
		# 'x_axis_label':"Cluster index",
		# 'y_axis_label':r'Energy prediction error ($?$)',
