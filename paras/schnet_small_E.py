...
parameters={	
	...
	'predict_error':{
		...
		'predicts':{
			0:{
				'predict_func':'func:schnet_predict_E',
				'input_var_index':3,
			},
		...
		0:{
			...
			'file_name':'RMSE_E_graph',
			'save_key':'RMSE_E_c', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':True,
			'graph_paras':{
				'y_axis_label':r'Energy prediction error $(kcal/mol\,\AA)$',
				'real_average_key':'RMSE_E_o'
		...
		1:{
			...
			'error_func':'func:root_mean_squared_error',
			'save_key':'RMSE_E_o', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':False,
			'graph_paras':{
			},
		},
		...
		2:{
			...
			'file_name':'MAE_E_graph',
			'save_key':'MAE_E_c', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':True,
			'graph_paras':{
				'y_axis_label':r'Energy prediction error $(kcal/mol\,\AA)$',
				'real_average_key':'MAE_E_o'
				#replace default paras here
			},
		},
		...
		3:{
			...
			'error_func':'func:mean_absolute_error',
			'save_key':'MAE_E_o', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':False,
			'graph_paras':{
			},
		}, 
		...
		4:{
			...
			'file_name':'MSE_E_graph',
			'save_key':'MSE_E_c', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':True,
			'graph_paras':{
				'y_axis_label':r'Energy prediction error $(kcal/mol\,\AA)^2$',
				'real_average_key':'MSE_E_o'
			},
		},
		...
		5:{
			...
			'error_func':'func:mean_squared_error',
			'save_key':'MSE_E_o', #will be saved in save.p under the given key (in 'errors' sub dict)
			'graph':False,
			'graph_paras':{
			},
		},	
